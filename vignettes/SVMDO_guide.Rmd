...
knitr::include_graphics("svmdo_analysis_screen.png")
```
<br><br><br>
```{r, ,echo=FALSE,  width = 200, height = 50,fig.align = "center",fig.show='hold'}
# two figs side by side
knitr::include_graphics("svmdo_result_screen.png")
```
...
4. Click on "Download R-X.X.X-win.exe for Windows"to install R-base
...
5. After the previous lines, run sudo apt install --no-install-recommends r-base 

**RStudio Install:

1. Copy/Paste the address  https://posit.co/download/rstudio-desktop/
2. In All Installers section, select .deb or .debian.tar.gz version for Ubuntu 
3. Right click on the download and/or unzipped .deb file to install RStudio
