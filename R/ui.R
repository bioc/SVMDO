...
ui <- fluidPage(
  ...
  fluidRow(
    ...
    column(4,
           div(style="display:inline-block", actionButton("initiate_do_analysis","DO Analysis")),
           div(style="display:inline-block",actionButton("initiate_wlsvmdo_analysis","Classification")))),
  ...
  fluidRow(
    column(12,
           div(style="display:inline-block", actionButton("initiate_surv_analysis","Survival Analysis")),
           div(style="display:inline-block",actionButton("clean_workspace","Clear Environment")))),
